...
| File | Size | Used by |
|---|---|---|
| `public/screenshots/fair-roads-fair-ui.jpg` | 299 KB, 1400×795 | homepage card `screenshot`, case-study `heroImage`, and the figure above the timeline |
...
All three files are committed. **Nothing in this plan is blocked on assets.**
